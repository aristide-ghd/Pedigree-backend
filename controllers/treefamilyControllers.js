        ...
        const aggregate = await Membre.aggregate([
...

            {
                $lookup: {
                    ...
                    let: { idpere: '$id_pere' }, // Variable locale pour l'identifiant du père
                    pipeline: [
                        {
                            $match: {
                                $expr: {
...

            {
                $lookup: {
                    ...
                    let: { idmere: '$id_mere' },  // Variable locale pour l'identifiant de la mère
                    pipeline: [
                        {
                            $match: {
                                $expr: {
...

            {
                $lookup: {   
                    ...
                    let: { iduser: '$id_user' },  // Variable locale pour l'identifiant de l'utilisateur
                    pipeline: [
                        {
                            $match: {
                                $expr: {
